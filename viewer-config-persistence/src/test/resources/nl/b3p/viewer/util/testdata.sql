...
INSERT INTO geo_service (protocol, id, authorizations_modified, monitoring_enabled, monitoring_statusok, name, password, url, username, tiling_protocol, exception_type, override_url, service_name, category, top_layer) VALUES ('wms', 4, '2018-11-22 13:34:29.301', false, true, 'woonplaatsen', 'w@chtw00rd', 'https://flamingo5.b3p.nl/geoserver/test_omgeving_fla5/wms', 'B3P', NULL, 'Inimage', false, NULL, 2, 1);
...
INSERT INTO metadata (id, config_key, config_value) VALUES (1, 'database_version', '36');
