 ...
 * Example:
 *
 * {@code mvn -Durl=https://test.tailormap.com/geoserver/Test_omgeving/wfs -Dtypename=Test_omgeving:cbs_gemeente_2014 -DtrimStackTrace=false -Dtest=GeoToolsWfsTest test}
 *
 * @author matthijsln
 */
