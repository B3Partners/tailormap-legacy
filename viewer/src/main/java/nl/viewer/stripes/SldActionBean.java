...
import nl.viewer.config.services.StyleLibrary;
    ...
    private void getSldXmlOrCreateNewSld() throws Exception {
        ...
        if (id != null) {
            ...
            if (commonAndFilter!=null){
                ...
                andFilter = TailormapCQL.toFilter(commonAndFilter, em);
            }
            if (commonOrFilter!=null){
                ...
                orFilter = TailormapCQL.toFilter(commonOrFilter, em);
            }
            if(layers != null) {
                ...
                for(int i = 0; i < layers.length; i++) {
                    ...
                    if(filters != null && i < filters.length && !"none".equals(filters[i]) && filters[i].length()>0) {
                         filter = TailormapCQL.toFilter(filters[i], em);
                    }
