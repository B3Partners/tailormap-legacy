...
import nl.geotools.data.arcgis.ArcGISFeatureReader;
import nl.geotools.data.arcgis.ArcGISFeatureSource;
    ...
    public Resolution getObjectIds() throws JSONException, Exception {
        ...
        try {
            ...
            if (layer != null && layer.getFeatureType() != null) {
                ...
                if (layer.getFeatureType().getFeatureSource() instanceof nl.viewer.config.services.ArcGISFeatureSource) {
