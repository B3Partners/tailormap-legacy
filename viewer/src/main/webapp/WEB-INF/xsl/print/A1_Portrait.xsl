...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
	...
	<xsl:variable name="map-width-px" select="'1400'"/>
	<xsl:variable name="map-height-px" select="'2198'"/>
	...
	<xsl:template name="layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="a1-staand" page-height="841mm" page-width="594mm" margin-top="10mm" margin-bottom="10mm" margin-left="10mm" margin-right="10mm">
	...
	<xsl:template match="info">
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xlink="http://www.w3.org/1999/xlink">
			...
			<fo:static-content flow-name="before">
					<fo:list-block provisional-label-separation="5mm" provisional-distance-between-starts="450mm">
