...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
	...
	<xsl:variable name="map-width-px" select="'375'"/>
	<xsl:variable name="map-height-px" select="'240'"/>
	...
	<xsl:template name="layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="a5-liggend" page-height="148mm" page-width="210mm" margin-top="10mm" margin-bottom="10mm" margin-left="10mm" margin-right="10mm">
	...
	<xsl:template match="info">
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xlink="http://www.w3.org/1999/xlink">
			...
			<fo:page-sequence master-reference="a5-liggend">
				<fo:static-content flow-name="before">
					<fo:list-block provisional-label-separation="5mm" provisional-distance-between-starts="90mm">
		...
		<xsl:choose>
			<xsl:when test="*">
				<fo:block xsl:use-attribute-sets="default-font">
					...
					<xsl:variable name="maxNumOfCols" select="'7'" as="xsl:integer"/>
