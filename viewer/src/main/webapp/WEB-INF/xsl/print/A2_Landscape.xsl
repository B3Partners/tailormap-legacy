...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
    ...
    <xsl:variable name="map-width-px" select="'1436'"/>
    <xsl:variable name="map-height-px" select="'1020'"/>
    ...
    <xsl:template name="layout-master-set">
        <fo:layout-master-set>
            <fo:simple-page-master master-name="a2-liggend" page-height="420mm" page-width="594mm" margin-top="10mm" margin-bottom="10mm" margin-left="10mm" margin-right="10mm">
        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <fo:page-sequence master-reference="a2-liggend">
                <fo:static-content flow-name="before">
                    <fo:list-block provisional-label-separation="5mm" provisional-distance-between-starts="460mm">
    ...
    <xsl:template name="map-block">
        ...
        <fo:block>
            <fo:external-graphic src="{$map}" content-height="scale-to-fit" content-width="scale-to-fit" scaling="uniform" 
                                             width="{$map-width-px}" height="{$map-height-px}" xsl:use-attribute-sets="simple-border"/>
        </fo:block>
    </xsl:template>
    ...
    <xsl:template name="logo-block">
        <fo:block>
            <fo:external-graphic src="url('TailormapLogo.png')" content-height="55px" content-width="scale-to-fit" scaling="uniform"/>
        </fo:block>
    </xsl:template>
