...
<html class="x-border-box theme-triton">
    <head>
        ...
        <c:if test="${(param.debug != true)}">
            <link rel="stylesheet" type="text/css" href="${contextPath}/viewer-components/bridge/styles.css">
            <script src="${contextPath}/viewer-components/bridge/runtime.js" type="module"></script>
            <script src="${contextPath}/viewer-components/bridge/runtime-es5.js" nomodule defer></script>
            <script src="${contextPath}/viewer-components/bridge/polyfills-es5.js" nomodule defer></script>
            <script src="${contextPath}/viewer-components/bridge/polyfills.js" type="module"></script>
            <script src="${contextPath}/viewer-components/bridge/scripts.js" defer></script>
            <script src="${contextPath}/viewer-components/bridge/main.js" type="module"></script>
            <script src="${contextPath}/viewer-components/bridge/main-es5.js" nomodule defer></script>
        </c:if>
