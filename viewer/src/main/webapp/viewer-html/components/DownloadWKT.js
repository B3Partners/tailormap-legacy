        ...
        Ext.Ajax.request({
            ...
            success: function (result) {
                ...
                if (response.success) {
                    ...
                    Ext.MessageBox.alert(i18next.t('viewer_components_downloadwkt_9'), response.message);
                }
            },
            failure: function (result) {
                this.config.viewerController.logger.error(result);
                var response = Ext.JSON.decode(result.responseText);
                Ext.MessageBox.alert(i18next.t('viewer_components_downloadwkt_10'), response.message);
            }
        });
    },
