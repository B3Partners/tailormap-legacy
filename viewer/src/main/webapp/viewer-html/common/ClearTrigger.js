 ...
 * @author <a href="https://github.com/geertplaisier">Geert Plaisier</a>
 * 
 * @link https://github.com/ralscha/Ext.ux.form.trigger.Clear
...
Ext.define('Ext.ux.form.trigger.Clear', {
    ...
    initEvents: function() {
        ...
        cmp.addCls(Ext.baseCSSPrefix + 'form-has-clear-trigger');
