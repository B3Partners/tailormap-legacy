    ...
    <stripes:layout-component name="body">
        <div id="content">
            ...
            <div id="form-container" class="attribute">
                <iframe src="<stripes:url beanclass="nl.tailormap.viewer.admin.stripes.LayarSourceActionBean" event="cancel"/>" id="editFrame" frameborder="0"></iframe>
            </div>
        </div>
            
        <script type="text/javascript" src="${contextPath}/resources/js/services/layarsource.js"></script>
        <script type="text/javascript">
            var gridurl = '<stripes:url beanclass="nl.tailormap.viewer.admin.stripes.LayarSourceActionBean" event="getGridData"/>';
            var editurl = '<stripes:url beanclass="nl.tailormap.viewer.admin.stripes.LayarSourceActionBean" event="edit"/>';
            var deleteurl = '<stripes:url beanclass="nl.tailormap.viewer.admin.stripes.LayarSourceActionBean" event="delete"/>';
