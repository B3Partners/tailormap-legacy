...
<stripes:layout-render name="/WEB-INF/jsp/templates/ext.jsp">
    ...
    <stripes:layout-component name="body">
        <div id="formcontent">
            <stripes:errors/>
            <stripes:messages/>
            <stripes:form beanclass="nl.tailormap.viewer.admin.stripes.LayarSourceActionBean">
                <c:choose>
        ...
        <script type="text/javascript">
            var attributesUrl = '<stripes:url beanclass="nl.tailormap.viewer.admin.stripes.LayarSourceActionBean" event="getAttributes"/>';
