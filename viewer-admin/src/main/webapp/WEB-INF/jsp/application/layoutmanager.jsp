...
<stripes:layout-render name="/WEB-INF/jsp/templates/ext.jsp">
    ...
    <stripes:layout-component name="body">
        ...
        <stripes:url var="url" beanclass="nl.tailormap.viewer.admin.stripes.LayoutManagerActionBean" event="config">
        ...
        <script type="text/javascript">
            ...
            Ext.onReady(function() {
                ...
                Ext.create('LayoutManager', {
                    ...
                    layoutSaveUrl: '<stripes:url beanclass="nl.tailormap.viewer.admin.stripes.LayoutManagerActionBean" event="saveApplicationLayout"/>',
                    removeComponentUrl: '<stripes:url beanclass="nl.tailormap.viewer.admin.stripes.LayoutManagerActionBean" event="removeComponent"/>'
                });
            });
        </script>
