...
Ext.define("viewer.File", {
    ...
    constructor: function(config) {        
        ...
        if(this.config.actionbeanUrl == null) {
            this.config.actionbeanUrl = actionBeans["file"];
        }
    },
    /**
    ...
    save: function(title,description,saveObject, successFunction, failureFunction) {
        ...
        Ext.Ajax.request({
            url: this.config.actionbeanUrl + "?save",
            params: {title:title, description: description, saveObject:saveObject}, 
