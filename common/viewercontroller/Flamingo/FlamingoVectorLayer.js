...
Ext.define("viewer.viewercontroller.flamingo.FlamingoVectorLayer",{
    ...
    removeAllFeatures : function(){
        var flamingoObj = viewerController.mc.viewerObject;//this.getFrameworkLayer();
    ...
    drawFeature : function(type){
       ...
       // viewerController.mc.viewerObject;//this.getFrameworkLayer().callMethod(this.getId(),"editMapDrawNewGeometry",this.getLayerName(),type );
        viewerController.mc.viewerObject.callMethod(this.getId(),"editMapDrawNewGeometry",this.getLayerName(),type );
    },

    /* stop editing */
    stopDrawDrawFeature : function(){
        //this.getFrameworkLayer().callMethod(this.getId(),"removeEditMapCreateGeometry",this.getLayerName());
        viewerController.mc.viewerObject.callMethod(this.getId(),"removeEditMapCreateGeometry",this.getLayerName());
    }
