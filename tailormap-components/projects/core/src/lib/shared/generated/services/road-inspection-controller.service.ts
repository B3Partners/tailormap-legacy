...
export class RoadInspectionControllerService extends BaseService {
  constructor(
   ...
   */
  static readonly Get1Path = '/weginspectie/{objectGuid}';
  ...
  get1$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoadInspectionControllerService.Get1Path, 'get');
    if (params) {
  ...
  update1$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoadInspectionControllerService.Update1Path, 'put');
    if (params) {
  ...
  delete1$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoadInspectionControllerService.Delete1Path, 'delete');
    if (params) {
  ...
  getAllPaged$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoadInspectionControllerService.GetAllPagedPath, 'get');
    if (params) {
  ...
  save1$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoadInspectionControllerService.Save1Path, 'post');
    if (params) {
  ...
  getAll1$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoadInspectionControllerService.GetAll1Path, 'get');
    if (params) {
