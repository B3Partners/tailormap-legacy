...
export class TreeInspectionControllerService extends BaseService {
  constructor(
   ...
   */
  static readonly Get5Path = '/boominspectie/{objectGuid}';
  ...
  get5$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TreeInspectionControllerService.Get5Path, 'get');
    if (params) {
  ...
  update4$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TreeInspectionControllerService.Update4Path, 'put');
    if (params) {
  ...
  delete4$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TreeInspectionControllerService.Delete4Path, 'delete');
    if (params) {
  ...
  getAllPaged3$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TreeInspectionControllerService.GetAllPaged3Path, 'get');
    if (params) {
  ...
  save4$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TreeInspectionControllerService.Save4Path, 'post');
    if (params) {
  ...
  getAll4$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TreeInspectionControllerService.GetAll4Path, 'get');
    if (params) {
