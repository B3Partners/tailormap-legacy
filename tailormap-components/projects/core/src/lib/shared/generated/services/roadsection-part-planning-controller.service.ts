...
export class RoadsectionPartPlanningControllerService extends BaseService {
  constructor(
   ...
   */
  static readonly Get3Path = '/wegvakonderdeelplanning/{objectGuid}';
  ...
  get3$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoadsectionPartPlanningControllerService.Get3Path, 'get');
    if (params) {
  ...
  update3$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoadsectionPartPlanningControllerService.Update3Path, 'put');
    if (params) {
  ...
  delete3$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoadsectionPartPlanningControllerService.Delete3Path, 'delete');
    if (params) {
  ...
  getAllPaged2$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoadsectionPartPlanningControllerService.GetAllPaged2Path, 'get');
    if (params) {
  ...
  save3$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoadsectionPartPlanningControllerService.Save3Path, 'post');
    if (params) {
  ...
  getAll3$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoadsectionPartPlanningControllerService.GetAll3Path, 'get');
    if (params) {
