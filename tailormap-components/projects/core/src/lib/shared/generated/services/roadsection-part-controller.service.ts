...
export class RoadsectionPartControllerService extends BaseService {
  constructor(
   ...
   */
  static readonly Get2Path = '/wegvakonderdeel/{objectGuid}';
  ...
  get2$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoadsectionPartControllerService.Get2Path, 'get');
    if (params) {
  ...
  update2$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoadsectionPartControllerService.Update2Path, 'put');
    if (params) {
  ...
  delete2$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoadsectionPartControllerService.Delete2Path, 'delete');
    if (params) {
  ...
  save2$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoadsectionPartControllerService.Save2Path, 'post');
    if (params) {
  ...
  getAll2$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoadsectionPartControllerService.GetAll2Path, 'get');
    if (params) {
  ...
  getAllPaged1$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoadsectionPartControllerService.GetAllPaged1Path, 'get');
    if (params) {
  ...
  wegvakkenOnPoint$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoadsectionPartControllerService.WegvakkenOnPointPath, 'get');
    if (params) {
