...
export class WeginspectieControllerService extends BaseService {
  constructor(
  ...
  get1$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, WeginspectieControllerService.Get1Path, 'get');
    if (params) {
  ...
  update1$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, WeginspectieControllerService.Update1Path, 'put');
    if (params) {
  ...
  delete1$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, WeginspectieControllerService.Delete1Path, 'delete');
    if (params) {
  ...
  getAllPaged$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, WeginspectieControllerService.GetAllPagedPath, 'get');
    if (params) {
  ...
  save1$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, WeginspectieControllerService.Save1Path, 'post');
    if (params) {
  ...
  getAll1$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, WeginspectieControllerService.GetAll1Path, 'get');
    if (params) {
