...
export interface VrijvLeiding extends Feature {
  ...
  bao_grond_zichtbaar?: number;
  bap_ruimte_zichtbaar?: number;
  bba_wortels?: number;
  ...
  inspectie_jaar?: number;
  inspectie_jaar_2?: number;
  inspectiecode?: string;
  inspectiedatum?: string;
  inspectienaam?: string;
  inspectietechniek?: string;
  kast_id?: string;
  kl_datum_bob_begin?: string;
  kl_datum_bob_eind?: string;
  kl_extern_bestand?: string;
  kl_herstel_object_guid?: string;
  kl_herstel_status?: string;
  kl_rioolkaart_selectie?: string;
  ...
  reg_begin?: string;
  reg_eind?: string;
  reiniging_jaar?: number;
  reiniging_jaar_2?: number;
