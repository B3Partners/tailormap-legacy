...
import nl.viewer.config.services.BoundingBox;
import nl.viewer.config.services.CoordinateReferenceSystem;
...
import static nl.viewer.config.services.Layer.DETAIL_WMS_STYLES;
import static nl.viewer.config.services.Layer.EXTRA_KEY_METADATA_URL;
