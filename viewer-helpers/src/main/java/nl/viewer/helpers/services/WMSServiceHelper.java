...
import static nl.viewer.config.services.GeoService.PARAM_PASSWORD;
import static nl.viewer.config.services.GeoService.PARAM_USERNAME;
import static nl.viewer.config.services.WMSService.PARAM_OVERRIDE_URL;
import static nl.viewer.config.services.WMSService.PARAM_SKIP_DISCOVER_WFS;
