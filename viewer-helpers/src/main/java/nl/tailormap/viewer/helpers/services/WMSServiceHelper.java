...
import static nl.tailormap.viewer.config.services.WMSService.PARAM_OVERRIDE_URL;
import static nl.tailormap.viewer.config.services.WMSService.PARAM_SKIP_DISCOVER_WFS;
